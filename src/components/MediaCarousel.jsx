    ...
    return (
        <section className="py-32 bg-primary relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                {/* Video Slider */}
                <div className="relative aspect-[16/7] md:aspect-[21/9] overflow-hidden rounded-[40px] border border-white/5">
                                ...
                                >
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <span className="text-white/40 font-body text-xs flex items-center gap-2">
                                            <Video className="w-3 h-3" /> {mediaVideos[currentIndex].duration}
                                        </span>
                                    </div>
                                    <h3 className="text-4xl md:text-6xl font-title font-black text-white mb-10 max-w-3xl">
                                        {mediaVideos[currentIndex].title}
                                    </h3>
                                    
                                    <div className="flex items-center gap-8">
                                        <button className="flex items-center gap-4 px-10 py-5 bg-white text-primary font-title font-bold text-lg hover:bg-tertiary transition-all group/play">
                                            <Play className="w-6 h-6 fill-primary group-hover/play:fill-primary transition-all" />
                                            شاهد الفيديو
                                        </button>
                                        <div className="hidden md:block w-32 h-px bg-white/20" />
                                        <div className="text-white/40 font-body text-sm uppercase tracking-widest">
                ...
                <div className="mt-20 flex justify-center">
                    <a href="/visual-library" className="inline-flex items-center gap-4 text-white/60 font-title font-bold hover:text-tertiary transition-colors group">
